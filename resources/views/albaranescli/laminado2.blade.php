...
/* Para asegurar que el contenido de la tabla sea scrolleable */
.table-container {
    max-height: 70vh; /* Ajusta según tus necesidades */
    overflow-y: auto;
}

/* Ajusta el margen superior de la tabla para evitar que se oculte bajo la barra de navegación */
.table-container {
    margin-top: 20px; /* Ajusta según la altura de tu barra de navegación */
}
